import { action, observable, onlyComputed, computed } from '../../src';
...
class TestStore {
  ...
  init() {
    ...
    this.personProfileTimes = 0;
    this.unmountedTimes = 0;
  }
  ...
  personProfileTimes: number;
  unmountedTimes: number;
}
